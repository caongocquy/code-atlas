...
const details: Record<string, string[]> = {
  ...
  semantic: [
    "Usage: code-atlas semantic <setup|status|test|upgrade|disable|clean> [path] [options]",
    "",
    "Configure optional semantic search, inspect it locally, probe it, or manage its index.",
    "",
    "Setup options:",
    "  --provider <builtin-local|openai-compatible>  Select a provider (prompted in a terminal if omitted)",
    "  --model <id>                                  Hugging Face model or OpenAI-compatible model",
    "  --revision <ref>                              Hugging Face branch, tag, or commit",
    "  --base-url <url>                              OpenAI-compatible endpoint",
    "  --api-key-env <name>                          Read an API key from this environment variable",
    "  --json                                        Print machine-readable output",
    "",
    "Built-in local models run in-process through Transformers.js + ONNX. Setup downloads and probes the model; indexing remains a separate command.",
  ],
  "context-read": [
