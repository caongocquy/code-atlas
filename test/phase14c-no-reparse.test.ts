...
test("framework-only version changes have no language parse/resolve requirement", () => {
  const plan = planFrameworkInvalidation({ paths: ["plain.ts"], changedInputKeys: new Set(), changedLookupKeys: new Set(), previous: { repositoryId: "repo", generationId: "g", frameworkResolutionVersion: "1.0.0", entities: [], relationships: [], classifications: [], diagnostics: [], coverage: [], config: [], detections: [], dependencies: [], complete: true }, frameworkResolutionVersion: "2.0.0", topologyComplete: true });
