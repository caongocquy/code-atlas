...
- Tests cover hit including `scope:0`, canonical round-trip, every miss reason including schema/language mismatch, actual cross-path/cross-repository reuse, direct SQLite corruption, repair, sequential writer immutability, and schema contents.
