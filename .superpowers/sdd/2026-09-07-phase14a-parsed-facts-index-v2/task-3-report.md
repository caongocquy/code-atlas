...
- Tests cover hit, deterministic round-trip, every miss reason, cross-path/cross-repository reuse, direct SQLite corruption, repair, and schema contents.
...
- `node --import tsx/esm --test test/phase14a-cache.test.ts` — 5/5 passed.
